...
with open('test_file.txt', 'rt', encoding='utf-8') as file:  # сохранен в cp1251... как тут можно нормально обработать?
    try:
        for line in file:
            print(line)
    except UnicodeDecodeError:
        print('***Кодировка чтения отличается от кодировки файла!***\n')
